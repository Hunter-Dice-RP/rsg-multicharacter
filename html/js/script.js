...
function startUI(panelConfig, musicConfigData) {
    ...
    setMusicConfig(musicConfigData);
...
function updateInvestigationPanels(raw) {
    ...
    console.log('[NUI] Investigación recibida:', data.data);
...
$(document).ready(function() {
    ...
    // 2. LISTENERS DE LA INTERFAZ DE MÚSICA
    ...
    // 4. LISTENERS DE LOS PANELES DE TELEGRAMAS,
    ...
    // 5. LISTENERS DE LOS PANELES DE ATUENDOS
    ...
    // 6. LISTENERS DE SELECCIÓN Y ACCIONES DE PERSONAJE
    $(document).on('click', '.character', function(e) {
        e.preventDefault();
